...
## 1. 算法设计及编程作业：[基于二维数组的图像问题 2D array with image (from Ms. Lu)](./materials/20190709-Array-2D.pdf) ，提交：算法设计流程图、伪代码、python程序及运行结果截屏。 ddl: 7.20
   * Daniel,Julian,[Lisa](https://github.com/ZeroxAlone/SVHW),Shirley,Wilbur,Vivien,Nico,Tim,James,[Andy](https://github.com/Loskiz/AS_CS_Homework/tree/master/1_IMAGE),Cathy,Brian,[**:trollface:Harry**](https://github.com/haoyuF996/AL-cs-homework-July-09-2019-2Darray),Jack
