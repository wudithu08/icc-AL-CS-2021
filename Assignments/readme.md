 ...
 * 2D array exercise: complete the code template -- exercise.py, to create the following images. see materials here: Assignments/arrays/exercise.py and Assignments/arrays/resultImg.jpg 
